...
echo	"<form name='login' method='post' action='verificacion.php'>
		<table border='0' width='100%'><!--width='100%' hace que se ajuste al tamaño de la ventana-->
			<tr>
				<td colspan='2'>
				<br /><!--salto de linea-->
				<br />
			...
			<tr>
				<td align='right' width='50%'> <!--width='50%' ajusta el tamaño de la columna al 50%-->
				Usuario:
				</td>
				<td align='left'>
			...
			<tr>
				...
				<br>
				<font color='red'>
            	<br>Usuario o contraseña incorrectos<br>
				</font>
				</td>
		</table>
		</form>
