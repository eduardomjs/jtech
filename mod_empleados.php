...
<?php
	...
	<h1 align='center' >Bienvenido al módulo de modificación de empleados</h1><br />";
	
	echo"
	<div>
	<form name='mod' method='post' action='registro_empleados3.php' target='registro_empleados3'>
	...
	echo"
	<div>
		<iframe name='registro_empleados3' src='registro_empleados3.php' width='100%' frameborder='0' height='120'>
		</iframe>
	</div>";
