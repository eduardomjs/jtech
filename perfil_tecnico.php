...
<?php
    echo    "
            ...
            <h1 align='center'>Perfil: Técnico</h1><br />
            <h1 align='center'>Sucursal: CDMX</h1><br />
            <table border='0' width='50%' align='center'>
                <tr>				    
		    		<td align='center'>
                        <form name='redirect' method='post' action='consulta_productos.php' align='center'>
                            <input type='submit' value='Realizar configuración' />
                        </form>
				    </td>
                    <td align='center'>
                        <form name='redirect' method='post' action='consulta_productos.php' align='center'>
                            <input type='submit' value='Consultar encargo' />
                        </form>
				    </td>
			    </tr>
            </table>
