...
<title>Procesadores más vendidos</title>
...
<?php
	...
	$consulta_productos="select id, imagen, marca, modelo, precio, unidades from productos_t where producto='Procesador' and unidades='1' order by marca";
	$resultado_productos=odbc_exec($link2,$consulta_productos);
	echo    "
			<form name='logout' method='post' action='index.php' align='right'>
				<input type='submit' value='Cerrar sesion' />
			</form>
			<h1 align='center'>PROCESADORES MAS VENDIDOS</h1><br />	
